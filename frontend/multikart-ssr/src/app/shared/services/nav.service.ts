...
export class NavService {
	...
	MENUITEMS: Menu[] = [
		{
			title: 'home', type: 'sub', active: false, path:'/',
				// children: [
				// {
		...
		// 		// 	]
		// 		// },
		// 		{ path: '/shop/product/three/column/trim-dress', title: 'Accessoires', type: 'link' },
		// 		{ path: '/shop/product/four/image/belted-dress', title: 'T-shirts', type: 'link' },
		// 		{ path: '/shop/product/bundle/trim-dress', title: 'Proteine', type: 'link' },
		// 		{ path: '/shop/product/image/outside/trim-dress', title: 'Categorie', type: 'link' }
		// 	]
		// },
		{
			title: 'Collections', type: 'sub', megaMenu: true, badge: true, badgeText: 'new', active: false, children: [
				{
					title: 'New arrival', type: 'sub', active: false, children: [
				...
				{
					title: 'Workout collection', type: 'sub', active: false, children: [
				...
				{
					title: 'Best gifts', type: 'sub', active: false, children: [
				...
				{
					title: 'For womens', type: 'sub', active: false, children: [
				...
				{
					title: 'Black friday', type: 'sub', active: false, children: [
